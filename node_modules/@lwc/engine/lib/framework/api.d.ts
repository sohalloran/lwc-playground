...
import { VNode, VNodeData, VNodes, VElement, VComment, VText, Key, VCustomElement } from "../3rdparty/snabbdom/types";
...
export declare function p(text: string): VComment;
...
export declare function k(compilerKey: number, obj: any): number | string | void;
export declare function gid(id: any): string | null | undefined;
