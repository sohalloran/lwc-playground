...
export declare function isComponentConstructor(Ctor: any): boolean;
export declare function getComponentDef(Ctor: ComponentConstructor, subclassComponentName?: string): ComponentDef;
/**
