declare const addEventListener: {
    <K extends "fullscreenchange" | "fullscreenerror">(type: K, listener: (this: Element, ev: ElementEventMap[K]) => any, options?: boolean | AddEventListenerOptions | undefined): void;
    (type: string, listener: EventListenerOrEventListenerObject, options?: boolean | AddEventListenerOptions | undefined): void;
}, removeEventListener: {
    <K extends "fullscreenchange" | "fullscreenerror">(type: K, listener: (this: Element, ev: ElementEventMap[K]) => any, options?: boolean | EventListenerOptions | undefined): void;
    (type: string, listener: EventListenerOrEventListenerObject, options?: boolean | EventListenerOptions | undefined): void;
}, hasAttribute: (qualifiedName: string) => boolean, getAttribute: (qualifiedName: string) => string | null, getAttributeNS: (namespace: string | null, localName: string) => string | null, setAttribute: (qualifiedName: string, value: string) => void, setAttributeNS: (namespace: string | null, qualifiedName: string, value: string) => void, removeAttribute: (qualifiedName: string) => void, removeAttributeNS: (namespace: string | null, localName: string) => void, querySelector: {
...
}, getBoundingClientRect: () => DOMRect | ClientRect, getElementsByTagName: {
