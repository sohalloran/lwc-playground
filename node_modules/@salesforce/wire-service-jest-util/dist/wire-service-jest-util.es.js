...
import { ValueChangedEvent, register as register$1, registerWireService } from '@lwc/wire-service';
...
function createAdapter(adapterId) {
    ...
    register$1(adapterId, (wiredEventTarget) => {
        done = false;
...
export { registerLdsTestWireAdapter, registerTestWireAdapter };
